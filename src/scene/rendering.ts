// @ts-nocheck
import { EffectComposer, OverrideMaterialManager, RenderPass } from "postprocessing";
...
export class Rendering {
  constructor(canvas, usePostProcess = false) {
    ...
    this.camera = new THREE.PerspectiveCamera(15, this.vp.canvas.width / this.vp.canvas.height, 0.1, 1000)
  ...
  dispose() {
    console.log("dispose", this.renderer)
